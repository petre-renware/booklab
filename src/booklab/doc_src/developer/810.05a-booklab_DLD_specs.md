...
Outpit text of last run method (equivalent of stdout when run a console process).

<a id="booklab.my_books.books_manager.Results.exit_html"></a>

#### exit\_html

Calculated field with output text in HTML format.
