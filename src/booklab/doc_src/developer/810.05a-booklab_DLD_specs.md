...
<a id="booklab.my_books.books_manager.MyBook.MY_BOOKS_URL_prefix"></a>

#### MY\_BOOKS\_URL\_prefix

URL prefix to add when accesing a book local (generated) site

<a id="booklab.my_books.books_manager.MyBook.MY_BOOK_URL"></a>

#### MY\_BOOK\_URL

instantiated book URL to local (generated) site

<a id="booklab.my_books.books_manager.MyBook.MY_BOOKS_ROOT"></a>

#### MY\_BOOKS\_ROOT

confusing name ? just duplicate the global one in class namespace

<a id="booklab.my_books.books_manager.MyBook.book_code"></a>

#### book\_code

instanciated book code

<a id="booklab.my_books.books_manager.MyBook.db_books_catalog"></a>

#### db\_books\_catalog

books catalog data controller

<a id="booklab.my_books.books_manager.MyBook.db_book_nav"></a>
...
```python
def __init__(db: pysondb, book_code: str)
```
...
```python
def renderBookConfig(start_from: int = 1) -> tuple
```
