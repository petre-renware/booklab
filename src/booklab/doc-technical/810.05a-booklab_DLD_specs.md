...
* [booklab.docs.docs.book\_tmpl.bkcmd\_gen\_final\_book](#booklab.docs.docs.book_tmpl.bkcmd_gen_final_book)
* [booklab.docs.docs.book\_tmpl.bkcmd\_start\_book\_preview](#booklab.docs.docs.book_tmpl.bkcmd_start_book_preview)
* [booklab.docs.docs.book\_tmpl](#booklab.docs.docs.book_tmpl)
* [booklab.docs.docs.book\_tmpl.bkcmd\_render\_cfg\_file](#booklab.docs.docs.book_tmpl.bkcmd_render_cfg_file)
  * [my\_name](#booklab.docs.docs.book_tmpl.bkcmd_render_cfg_file.my_name)
  * [my\_crt\_dir](#booklab.docs.docs.book_tmpl.bkcmd_render_cfg_file.my_crt_dir)
  * [splitted\_my\_real\_dir](#booklab.docs.docs.book_tmpl.bkcmd_render_cfg_file.splitted_my_real_dir)
  * [book\_directory\_name](#booklab.docs.docs.book_tmpl.bkcmd_render_cfg_file.book_directory_name)
  * [book\_database\_code](#booklab.docs.docs.book_tmpl.bkcmd_render_cfg_file.book_database_code)
  * [bcat\_records](#booklab.docs.docs.book_tmpl.bkcmd_render_cfg_file.bcat_records)
  * [bcat\_records](#booklab.docs.docs.book_tmpl.bkcmd_render_cfg_file.bcat_records)
  * [templates\_root](#booklab.docs.docs.book_tmpl.bkcmd_render_cfg_file.templates_root)
  * [source\_config\_file](#booklab.docs.docs.book_tmpl.bkcmd_render_cfg_file.source_config_file)
  * [destination\_config\_file](#booklab.docs.docs.book_tmpl.bkcmd_render_cfg_file.destination_config_file)
  * [bcat\_jinja\_tmpl](#booklab.docs.docs.book_tmpl.bkcmd_render_cfg_file.bcat_jinja_tmpl)
* [booklab.docs.docs](#booklab.docs.docs)
...
<a id="booklab.docs.docs.book_tmpl.bkcmd_gen_final_book"></a>

# booklab.docs.docs.book\_tmpl.bkcmd\_gen\_final\_book

<a id="booklab.docs.docs.book_tmpl.bkcmd_start_book_preview"></a>

# booklab.docs.docs.book\_tmpl.bkcmd\_start\_book\_preview

<a id="booklab.docs.docs.book_tmpl"></a>

# booklab.docs.docs.book\_tmpl

<a id="booklab.docs.docs.book_tmpl.bkcmd_render_cfg_file"></a>

# booklab.docs.docs.book\_tmpl.bkcmd\_render\_cfg\_file

<a id="booklab.docs.docs.book_tmpl.bkcmd_render_cfg_file.my_name"></a>

#### my\_name

use `__file__` attribute which guarantees the full pth-and-name of current python file (ATTN if is in a library !)

<a id="booklab.docs.docs.book_tmpl.bkcmd_render_cfg_file.my_crt_dir"></a>

#### my\_crt\_dir

normally this should be the site root directory (in production `docs/` & in dev `doc_src/`)

<a id="booklab.docs.docs.book_tmpl.bkcmd_render_cfg_file.splitted_my_real_dir"></a>

#### splitted\_my\_real\_dir

split directory path in its parts

<a id="booklab.docs.docs.book_tmpl.bkcmd_render_cfg_file.book_directory_name"></a>

#### book\_directory\_name

get last list entry as being the book name where intend to obtain the book code (book dir name format: book_<code>)

<a id="booklab.docs.docs.book_tmpl.bkcmd_render_cfg_file.book_database_code"></a>

#### book\_database\_code

keep only characters after `book_`, sufix name of directory ((book dir name format: book_<code>))

<a id="booklab.docs.docs.book_tmpl.bkcmd_render_cfg_file.bcat_records"></a>
...
<a id="booklab.docs.docs.book_tmpl.bkcmd_render_cfg_file.templates_root"></a>

#### templates\_root

directory where the file is that need to be renderend (book_mkdocs.yml)

<a id="booklab.docs.docs.book_tmpl.bkcmd_render_cfg_file.source_config_file"></a>

#### source\_config\_file

source file (JINJA)

<a id="booklab.docs.docs.book_tmpl.bkcmd_render_cfg_file.destination_config_file"></a>

#### destination\_config\_file

destination file (YAML)

<a id="booklab.docs.docs.book_tmpl.bkcmd_render_cfg_file.bcat_jinja_tmpl"></a>

#### bcat\_jinja\_tmpl

load read file content as template

<a id="booklab.docs.docs"></a>
