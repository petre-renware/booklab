...
with open(os.path.join(templates_root + "book_mkdocs.yml")) as f: # read file and load its content as template #NOTE here maybe consider original file as *.yml.tmpl and saved one as *.yml
    c = f.read()
...
#FIXME ...RESULTING... #NOTE here maybe consider original file as *.yml.tmpl and saved one as *.yml
