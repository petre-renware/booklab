...
* **Manuale de utilizare**, acestea prezinta informatii pentru utilizarea curenta a aplicatiei. Cestea trebuie sa poata fi accesate de ln a `<SERVER NAME>/help/880.30-EUMA_catalog.html`
