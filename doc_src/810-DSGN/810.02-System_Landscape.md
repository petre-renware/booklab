...
* **Manuale de utilizare**, acestea prezinta informatii pentru utilizarea curenta a aplicatiei. Catalogul acestora se poate accesa de la `<SERVER NAME>/help/880.30-EUMA_catalog.html`

* **Manuale de configurare**, acestea prezinta informatii pentru configurarea aplicatiei. Catalogul acestora se poate accesa de la `<SERVER NAME>/help/880.30-ADMA_catalog.html`
...
-#TODO... ![wip doc](../pictures/under_maintenance.png){ width="200" }
-#NOTE: what design to make here??? it exists !!! under static portal the help zone... maybe just write some words about that
