...
!!! info "parametrii"
    ...
    * _locatie scriptu PRIMA INSTALARE_: `setup/`
...
* **interfata UI "Catalog cartil"** ce este interfata CLIENT-UI[^1] pentru managementul catalogului cartilor oferind operatii tip CRUD asupra bazei de date cu catalogul cartilor.
...
!!! info "parametrii"
    ...
    * _CLIENT-UI locatie_: `docs/bcat/index.html` (`doc_src/index.md` before 1-st compilation)
...
!!! info "parametrii"
    ...
    * _CLIENT locatie_: --- #TODO nestabilit inca - update it
