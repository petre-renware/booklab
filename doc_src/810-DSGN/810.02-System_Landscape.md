...
!!! warning "Conceptele de server si client"
    ...
    * Locatiile pentru _partea de CLIENT_ sunt situate dupa o organizare clasica de site static incepind cu / din directorul `docs/` iar codul este prezent in fisier `.html` (in rare cazuri pot fi mai multe dar incep cu acelasi prefix).
