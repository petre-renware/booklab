...
<!-- #TODO consider to make it a dedicated document #FIXME drop when finish -->
...
...tbd... <!-- #TODO continue with sections fro each item what exactly contains + efective development details -->
