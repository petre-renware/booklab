...
Fiecare script (comanda) poate primi ca paramtru de intrare (si daca il primeste este *pozitional si primul*) **identificatorul cartii sub forma atributului / cheii `code`** din baza de date cu carti (`<PROJECT_ROOT>/data/books_catalog.json`).
...
* **`bkcmd_assembly_cfg_file.sh`** - asambleaza fisierul de configurare a cartii din partile componente, [vezi sectiunea "Fisierul de configurare a cartii"](#fisierul-de-configurare-a-cartii)

* tbd... **`bkcmd_start_book_preview.sh`** 
* tbd... **`bkcmd_gen_final_book.py`** 
* tbd... **`bkcmd_start_book_preview.py`** 
* tbd... **`...`** 
* tbd... **`...`** 
...
<!-- #TODO de enumerat toate directoarele -->
![wip page](../pictures/under_maintenance.png){ width="200" }
