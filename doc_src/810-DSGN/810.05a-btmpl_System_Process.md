...
!!! info "LOCALIZARE"
    Procesul de generare a fisierului de configurare comporta 2 faze:
    ...
    * **Localizarea fisierelor**
        * *fisierul FINAL de configurare*: `<book_directory>/book_config_parts/cfg_01_head_yml_section.yml`
        * *fisierul temporar de configurare*: `<book_directory>/book_config_parts/cfg_01_head_yml_section.yml.tmpl`
