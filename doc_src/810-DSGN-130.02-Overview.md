...
**BookLab** este compus din (<small markdown>termenii *modul* si *componenta* sunt utilizate cu acelasi sens in aceasta despcriere si pot fi interschimbate fara a altera sensul descrierii</small>):
