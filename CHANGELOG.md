...
* [0.7.dev22] update my_books/books_catalog.json making full flat structure: drop "status" key and move its keys one level up + drop "location" key that will be obtained through MyBook class
