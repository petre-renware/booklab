...
* ... [0.7rc0] routes.py: code preview route (`/api/prvb/`) for a book resulted static-site as route /preview/<my_book_code>/docs/
* ... [0.7a0] bstatus_template: change Edit action, disable it for closed books
