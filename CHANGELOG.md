...
* ...wip [0.4rc3] 250914...
    ...
    * ... upd `bcat_template.md` to send book code as route-part like `/api/req-op/<book code here>/` because query params are not preserved by static site at redirection with <a> tag
* [0.4rc2] 250913
