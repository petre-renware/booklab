...
* ...wip [0.4b14] yymmdd... static site: create all book-operations directories with index.html like /bcat/index.html but with meta redirect commented but presenting WIP-worker-picture
