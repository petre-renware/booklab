...
<meta content="Petre Iordanescu, RENware Software Systems, petre.iordanescu@gmail.com" name="author"/>
<link href="../assets/images/favicon.png" rel="icon"/>
<meta content="mkdocs-1.5.2, mkdocs-material-9.1.21" name="generator"/>
<title>Bcat - BookLab</title>
...
<a class="md-skip" href="#catalogul-cartilor">
          Skip to content
        </a>
</div>
...
<a aria-label="BookLab" class="md-header__button md-logo" data-md-component="logo" href=".." title="BookLab">
<img alt="logo" src="../pictures/booklab_logo.png"/>
</a>
...
<li class="md-tabs__item">
<a class="md-tabs__link" href="../help/130.02-Overview.html">
        Help
      </a>
</li>
<li class="md-tabs__item">
<a class="md-tabs__link" href="../wip.html">
        About
      </a>
</li>
</ul>
...
<a aria-label="BookLab" class="md-nav__button md-logo" data-md-component="logo" href=".." title="BookLab">
<img alt="logo" src="../pictures/booklab_logo.png"/>
</a>
    BookLab
  </label>
...
<li class="md-nav__item">
<a class="md-nav__link" href="../newb/">
        Carte noua
      </a>
</li>
<li class="md-nav__item">
<a class="md-nav__link" href="../edtm/">
        Editare materiale
      </a>
</li>
<li class="md-nav__item">
<a class="md-nav__link" href="../orgm/">
        Sectiuni carte
      </a>
</li>
<li class="md-nav__item">
<a class="md-nav__link" href="../prvb/">
        Previzualizare carte
      </a>
</li>
<li class="md-nav__item">
<a class="md-nav__link" href="../dplb/">
        Asamblare carte
      </a>
</li>
</ul>
...
<ul class="md-nav__list" data-md-scrollfix="">
<li class="md-nav__item">
<a class="md-nav__link" href="../help/130.02-Overview.html">
        Vedere de ansamblu
      </a>
</li>
<li class="md-nav__item md-nav__item--nested">
...
<ul class="md-nav__list" data-md-scrollfix="">
<li class="md-nav__item">
<a class="md-nav__link" href="../help/880.30-EUMA_catalog.html">
        Indexul manuale EUMA
      </a>
</li>
<li class="md-nav__item">
<a class="md-nav__link" href="../help/880.30-BCAT_usage.html">
        Catalog carti
      </a>
</li>
</ul>
...
<ul class="md-nav__list" data-md-scrollfix="">
<li class="md-nav__item">
<a class="md-nav__link" href="../help/880.30-ADMA_catalog.html">
        Indexul manuale ADMA
      </a>
</li>
<li class="md-nav__item">
<a class="md-nav__link" href="../help/880.30-TMPL_usage.html">
...
<ul class="md-nav__list" data-md-scrollfix="">
<li class="md-nav__item">
<a class="md-nav__link" href="../810-DSGN/810.02-System_Landscape.html">
        Arhitectura sistemului
      </a>
</li>
<li class="md-nav__item">
<a class="md-nav__link" href="../810-DSGN/810.05a-sysInit_System_Process.html">
        modul Initializare sistem (sysInit)
      </a>
</li>
<li class="md-nav__item">
<a class="md-nav__link" href="../810-DSGN/810.05a-bcat_System_Process.html">
        modul Catalog Carti (BCAT)
      </a>
</li>
<li class="md-nav__item">
<a class="md-nav__link" href="../810-DSGN/810.05a-btmpl_System_Process.html">
        modul Sablon Carti (TMPL)
      </a>
</li>
<li class="md-nav__item">
<a class="md-nav__link" href="../810-DSGN/810.05a-newb_System_Process.html">
        modul Carte Noua (NEWB)
      </a>
</li>
<li class="md-nav__item">
<a class="md-nav__link" href="../810-DSGN/810.05a-edtm_System_Process.html">
        modul Editare Carte (EDTM)
      </a>
</li>
<li class="md-nav__item">
<a class="md-nav__link" href="../810-DSGN/810.05a-orgm_System_Process.html">
        modul Organizare Carte (ORGM)
      </a>
</li>
<li class="md-nav__item">
<a class="md-nav__link" href="../810-DSGN/810.05a-prvb_System_Process.html">
        modul Previzualizare Carte (PRVB)
      </a>
</li>
<li class="md-nav__item">
<a class="md-nav__link" href="../810-DSGN/810.05a-dplb_System_Process.html">
        modul Generare Carte (DPLB)
      </a>
</li>
</ul>
</nav>
...
<li class="md-nav__item">
<a class="md-nav__link" href="../pdfs/print_page.html/print_page.pdf">
        Manual BookLab (PDF)
      </a>
</li>
</ul>
...
<ul class="md-nav__list" data-md-scrollfix="">
<li class="md-nav__item">
<a class="md-nav__link" href="../wip.html">
        Licenta mea
      </a>
</li>
<li class="md-nav__item">
<a class="md-nav__link" href="https://www.renware.eu/support.html">
        Suport
      </a>
</li>
<li class="md-nav__item">
<a class="md-nav__link" href="https://www.renware.eu/contact.html">
        Contact
      </a>
</li>
<li class="md-nav__item">
<a class="md-nav__link" href="https://www.renware.eu/resources.html#how-to-buy-from-renware">
        Cum cumpar
      </a>
</li>
<li class="md-nav__item">
...
<li class="md-nav__item">
<a class="md-nav__link" href="#lista-cartilor">
    Lista cartilor
  </a>
</li>
<li class="md-nav__item">
...
<article class="md-content__inner md-typeset"><div class="download-btn"><a href="..\pdfs\bcat\bcat.html\bcat.pdf">Download PDF</a></div>
<!-- #NOTE

    * page dedicated for books catalog

    * for Jinja fields processable @ server-side use ` ... ` construction to remain in resulted HTML afer 1st compilation with mkdocs

 -->
<h1 id="catalogul-cartilor">Catalogul cartilor</h1>
<p>Bine ati venit la <em>Catalogul cartilor dumneavoastra</em>. Aici puteti vizualiza cartile create de dumneavoastra si stadiul acestora, sa efectuati operatii asupra lor sau sa creati o carte noua.</p>
<h2 id="lista-cartilor">Lista cartilor</h2>
<p><a href="newb/">Creare carte</a> <!--#NOTE action for new book --></p>
<!-- #NOTE dropdown commands button CSS -->
<style>
/* Dropdown Button */
.dropbtn {
...
<!--#NOTE contains dropdown commands button CSS -->
<table>
<thead>
<tr>
<th>ID</th>
...
<div class="dropdown">
<button class="dropbtn" onclick="activateDropdown()">OP ⯆</button>
<div class="dropdown-content" id="bkcommandsDropdown">
...
<h2 id="help"><a href="../help/880.30-BCAT_usage.html">Help</a></h2>
<!-- #NOTE dropdown commands button JS-->
<script>
/* When the user clicks on the button, 
toggle between hiding and showing the dropdown content */
function activateDropdown() {
  document.getElementById("bkcommandsDropdown").classList.toggle("show");
}
...
<!--#NOTE contains dropdown commands button JS -->
<hr/>
<div class="md-source-file">
<small>
    
      Last update:
      <span class="git-revision-date-localized-plugin git-revision-date-localized-plugin-date">October 23, 2023</span>
</small>
</div>
</article>
</div>
